    ...
    return (
        <div className="cursor" style={{ width: '100vw', height: '100vh', backgroundColor: '#666', position: 'absolute', opacity: '90%', top: '0', left: '0', border: '1vh dotted #7FA0F4', boxSizing: 'border-box' }}>
            ...
            <h1 className="text" style={{ fontFamily: 'Bohemian', fontSize: '2vh', fontWeight: '700', color: '#ffc40c', padding: '5vh'  }}>
                Sam here: First I'd like to thank you for stopping by and sharing my space! I love the idea of creating small worlds for people to go off to and explore. I am a fervent animal and plant lover, love going to art museums, and learning about history. A self-proclaimed code monkey, I love making apps, websites, and games. I'm currently studying for a master's degree in Computer Science at Stanford. In my free time, I love making and discovering digital and tangible art. Although classically trained in violin, I have started experimenting with different genres and enjoy jazz, soul, and dreamscape.
            </h1>
