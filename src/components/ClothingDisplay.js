...
const ClothingDisplay = (props) => {
    ...
    return (
        <div className="cursor" style={{ borderRadius: '2vw', backgroundImage:`url('./sewing/pattern.png')`, width: '45vh', height: '45vh', position: 'absolute', bottom: '6vh', left: '35vw' }}>
            ...
            />
            <div style={{display:'flex', justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', border: '1vh solid black', position: 'absolute', right: '3vh', top: '1vh', width: '4vh', height: '4vh'}}>
                <h1 className="cursor-hover close-text" style={{fontFamily: 'Bohemian', fontSize: '3vh', color: 'black'}} onClick={clickingX}>x</h1>
            </div>
